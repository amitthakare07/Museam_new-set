        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 mb-4 mb-md-0">
            ...
            <p className="footer-text">
              Email: <a href="mailto:contact@louvre.fr">contact@louvre.fr</a>
            </p>
            <p className="footer-copy mt-3">
              &copy; {new Date().getFullYear()} Louvre Museum. All rights reserved.
            </p>
          </div>
          ...
          <div className="col-md-6 text-md-end text-center">
            ...
            <div className="footer-social d-flex justify-content-md-end justify-content-center gap-4 mt-3">
              ...
              <a
                href="https://instagram.com/yourmuseum"
